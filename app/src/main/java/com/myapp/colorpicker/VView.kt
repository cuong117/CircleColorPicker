...
class VView(context: Context, attrs: AttributeSet?) : View(context, attrs), HSView.OnHSChange {
    ...
    private var polygonTop = AppCompatResources.getDrawable(context, R.drawable.ic_polygon)
    private var polygonBottom =
        AppCompatResources.getDrawable(context, R.drawable.ic_polygon_bottom)
